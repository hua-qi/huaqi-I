...
_BUILTIN_DEFAULTS: dict[str, str] = {
    ...
    "layers.capabilities.world_news_enricher_source": (
        "<!-- scene: layers.capabilities.world_news_enricher_source"
        " | variables: source_name, article_count, article_list, user_context -->\n"
        "你是一位专业新闻编辑和私人助理。"
        "以下是来自 **{{source_name}}** 的 {{article_count}} 篇文章。\n"
        "\n"
        "{{user_context}}\n"
        "\n"
        "## 文章列表\n"
