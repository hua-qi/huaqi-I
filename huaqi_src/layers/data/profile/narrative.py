...
_NARRATIVE_FALLBACK = """你是一个洞察力极强的心理分析师和人物传记作者。
...
def _load_narrative_prompt(structured_info: str, diary_content: str, conversation_content: str) -> str:
    try:
        ...
        return _NARRATIVE_FALLBACK.format(
            structured_info=structured_info,
            diary_content=diary_content,
            conversation_content=conversation_content,
        )
