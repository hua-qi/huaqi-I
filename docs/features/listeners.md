...
非 codeflicker 类型（如 `claude`）不写入 WorkLog。
...
| 文件 | 说明 |
|------|------|
| `huaqi_src/layers/data/collectors/cli_chat_parser.py` | codeflicker/Claude 对话文件解析器 |
| `huaqi_src/layers/data/collectors/cli_chat_watcher.py` | CLI 对话目录监听器 |
