...
- **output_dir 注入不可验证**：通过 prompt 前缀要求 LLM 将结果写入指定文件，但无法强制保证。这是已知限制（见 `docs/iterations/2026-04-09-scheduler-deep-audit/plan.md` Bug H），当前优先级下可接受。
...
- `docs/iterations/2026-05-18-scheduler/feature.md`
