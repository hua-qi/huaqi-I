...
| `huaqi_src/core/profile_narrative.py` | LLM 叙事性画像生成 | ⭐⭐⭐⭐ |
| `huaqi_src/core/profile_extractor.py` | 启动时后台数据提取 | ⭐⭐⭐ |
...
| `huaqi_src/core/adaptive_understanding.py` | 自适应用户理解（门面） | ⭐⭐⭐⭐ |
| `huaqi_src/memory/vector/hybrid_search.py` | 混合检索引擎 | ⭐⭐⭐⭐⭐ |
| `huaqi_src/pipeline/core.py` | 内容流水线主逻辑 | ⭐⭐⭐⭐ |
| `huaqi_src/scheduler/manager.py` | APScheduler 定时任务封装 | ⭐⭐⭐⭐ |
| `docs/guides/code-organization.md` | 代码及文件组织规范（agent 参考） | ⭐⭐⭐⭐⭐ |
...
**文档版本**: v1.2
**生成时间**: 2026-03-29
**更新说明**: 新增 CLI 层拆分结构（huaqi_src/cli/）、user_profile 拆分（profile_models/manager/narrative/extractor）、完整源码目录树
